...
const featuredPosts = [
  ...
  },
  {
    ...
    title: "【2026年最新】ChatGPT vs Claude 徹底比較",
    description:
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span
                    className={`text-xs font-semibold px-2.5 py-1 rounded-full ${badgeClass[post.categorySlug]}`}
                  >
                    {post.category}
                  </span>
                </div>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {categories.map((cat) => (
              ...
              >
                ...
                <div className="mt-3 text-xs font-medium text-indigo-500">
                  {cat.count}件の記事 →
                </div>
              </Link>
            ))}
